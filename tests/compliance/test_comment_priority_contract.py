...
def test_comment_priority_never_exceeds_tool_priority() -> None:
    ...
    assert SOURCE_PRIORITY[SourceName.github_review_comments] < SOURCE_PRIORITY[SourceName.codecov_cloud]
    assert SOURCE_PRIORITY[SourceName.github_review_comments] < SOURCE_PRIORITY[SourceName.coderabbit]
